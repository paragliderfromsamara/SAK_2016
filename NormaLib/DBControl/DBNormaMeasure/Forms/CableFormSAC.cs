...
{
    public partial class CableFormSAC : CableForm
    {

        public CableFormSAC() : base()
        {
        }

        public CableFormSAC(uint cable_id) : base(cable_id)
        {
        }

        public CableFormSAC(Cable copiedCable) : base(copiedCable)
        {
        ...
        protected override void InitFormByAssignedCable()
        {
            base.InitFormByAssignedCable();
            InitStructuresTabControl();
        }

/*
        protected override void FillDBData()
        {
            base.FillDBData();
...
*/
        ...
        {
            base.fillStructureTypes();
            structureTypesComboBox.DataSource = cableFormDataSet.Tables["cable_structure_types"];
      ...
      /*  private string reloadDocumentsDS()
        ...
        */
        ...
        /// </summary>
        protected override void refreshBuildLengthOnStructureMeasureParameters()
        {
